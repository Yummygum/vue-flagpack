import { defineComponent as m, openBlock as p, createElementBlock as i, normalizeClass as o, createElementVNode as t } from "vue";
var h = {}, l = {}, u = {};
Object.defineProperty(u, "__esModule", { value: !0 });
u.countryCodeList = void 0;
u.countryCodeList = [
  ...
  { countryName: "\xC5land Islands", alpha2: "AX", alpha3: "ALA", numeric: "248" },
  ...
  { countryName: "C\xF4te d'Ivoire", alpha2: "CI", alpha3: "CIV", numeric: "384" },
  ...
  { countryName: "Cura\xE7ao", alpha2: "CW", alpha3: "CUW", numeric: "531" },
  {
  ...
  { countryName: "R\xE9union", alpha2: "RE", alpha3: "REU", numeric: "638" },
...
l.isoToCountryCode = void 0;
const N = u;
function y(a, e = "alpha2") {
  if (a !== void 0)
    return N.countryCodeList.find((n) => n.alpha2 === a || n.alpha3 === a || n.numeric === a)[e];
  throw new Error("This code returns undefined, see https://www.flagpack.xyz/docs/flag-index for all the available codes.");
}
l.isoToCountryCode = y;
(function(a) {
  Object.defineProperty(a, "__esModule", { value: !0 }), a.isoToCountryCode = void 0;
  var e = l;
  Object.defineProperty(a, "isoToCountryCode", { enumerable: !0, get: function() {
    return e.isoToCountryCode;
  } });
})(h);
const s = m({
  name: "Flag",
  computed: {
    imageUrl() {
      return require(`flagpack-core/svg/${this.size.toLowerCase()}/${h.isoToCountryCode(this.code).toUpperCase()}.svg`);
    }
  },
  props: {
    size: {
    ...
    gradient: {
      type: String,
      validator: (a) => ["top-down", "real-linear", "real-circular"].indexOf(a) !== -1
    },
    className: String
  }
});
...
function M(a, e, r, n, c, A) {
  return p(), i("div", {
    class: o([
      "flag",
      `size-${a.size}`,
      { "border-radius": a.hasBorderRadius },
      { border: a.hasBorder },
...
const C = /* @__PURE__ */ d(s, [["render", M], ["__scopeId", "data-v-c8d56693"]]), G = {
  install: (a, e) => {
    a.component(e.name || "vue-flagpack", C);
  }
};
export {
  C as Flag,
