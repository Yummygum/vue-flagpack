...
var US_vue_rollupPluginVue_script = require('./US.vue_rollup-plugin-vue=script.js');

/* script */
const __vue_script__ = US_vue_rollupPluginVue_script['default'];
