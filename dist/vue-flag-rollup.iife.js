var Flag = (function (exports, flagpackCore) {
  ...
  var script = {
    ...
    computed: {
      imageUrl() {
        return flagpackCore.imageUrl(flagpackCore.isoToCountryCode(this.code).toUpperCase(), this.size.toLowerCase())
      }
    },
    props: {
      size: {
  ...
  exports.Flag = __vue_component__;
